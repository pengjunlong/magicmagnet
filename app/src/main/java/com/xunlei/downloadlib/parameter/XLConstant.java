...
public class XLConstant {
    ...
    public static final class XLCreateTaskMode {
        private static final /* synthetic */ XLCreateTaskMode[] $VALUES = null;
        public static final XLCreateTaskMode CONTINUE_TASK = null;
        public static final XLCreateTaskMode NEW_TASK = null;

        private XLCreateTaskMode(String str, int i) {
        }

        public static XLCreateTaskMode valueOf(String str) {
        }

        public static XLCreateTaskMode[] values() {
        }
    }

    /* JADX WARN: Failed to restore enum class, 'enum' modifier and super class removed */
    /* JADX WARN: Unexpected branching in enum static init block */
    public static final class XLDownloadHeaderState {
        private static final /* synthetic */ XLDownloadHeaderState[] $VALUES = null;
        public static final XLDownloadHeaderState GDHS_ERROR = null;
        public static final XLDownloadHeaderState GDHS_REQUESTING = null;
        public static final XLDownloadHeaderState GDHS_SUCCESS = null;
        public static final XLDownloadHeaderState GDHS_UNKOWN = null;

        private XLDownloadHeaderState(String str, int i) {
        }

        public static XLDownloadHeaderState valueOf(String str) {
        }

        public static XLDownloadHeaderState[] values() {
        }
    }
    ...
    public static class XLErrorCode {
        ...
        public static final int ERR_SCDN_FAIL = 119000;
    ...
    /* JADX WARN: Failed to restore enum class, 'enum' modifier and super class removed */
    /* JADX WARN: Unexpected branching in enum static init block */
    public static final class XLManagerStatus {
        private static final /* synthetic */ XLManagerStatus[] $VALUES = null;
        public static final XLManagerStatus MANAGER_INIT_FAIL = null;
        public static final XLManagerStatus MANAGER_RUNNING = null;
        public static final XLManagerStatus MANAGER_UNINIT = null;

        private XLManagerStatus(String str, int i) {
        }

        public static XLManagerStatus valueOf(String str) {
        }

        public static XLManagerStatus[] values() {
        }
    }

    /* JADX WARN: Failed to restore enum class, 'enum' modifier and super class removed */
    /* JADX WARN: Unexpected branching in enum static init block */
    public static final class XLNetWorkCarrier {
        private static final /* synthetic */ XLNetWorkCarrier[] $VALUES = null;
        public static final XLNetWorkCarrier NWC_CMCC = null;
        public static final XLNetWorkCarrier NWC_CT = null;
        public static final XLNetWorkCarrier NWC_CU = null;
        public static final XLNetWorkCarrier NWC_Unknow = null;

        private XLNetWorkCarrier(String str, int i) {
        }

        public static XLNetWorkCarrier valueOf(String str) {
        }

        public static XLNetWorkCarrier[] values() {
        }
    }
    ...
    /* JADX WARN: Failed to restore enum class, 'enum' modifier and super class removed */
    /* JADX WARN: Unexpected branching in enum static init block */
    public static final class XLQueryIndexStatus {
        private static final /* synthetic */ XLQueryIndexStatus[] $VALUES = null;
        public static final XLQueryIndexStatus QIS_QUERYING = null;
        public static final XLQueryIndexStatus QIS_QUERY_HAVENT_INFO = null;
        public static final XLQueryIndexStatus QIS_QUERY_HAVE_INFO = null;
        public static final XLQueryIndexStatus QIS_UNQUERY = null;

        private XLQueryIndexStatus(String str, int i) {
        }

        public static XLQueryIndexStatus valueOf(String str) {
        }

        public static XLQueryIndexStatus[] values() {
        }
    }

    /* JADX WARN: Failed to restore enum class, 'enum' modifier and super class removed */
    /* JADX WARN: Unexpected branching in enum static init block */
    public static final class XLResStrategy {
        private static final /* synthetic */ XLResStrategy[] $VALUES = null;
        public static final XLResStrategy RUS_PRIOR_USE = null;

        private XLResStrategy(String str, int i) {
        }

        public static XLResStrategy valueOf(String str) {
        }

        public static XLResStrategy[] values() {
        }
    }
