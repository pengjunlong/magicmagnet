...
class XLLoader {
    private static final String LIB_FFMPEG0 = "ffmpeg0";
    private static final String LIB_MAGICMAGNET_SDK = "magicmagnetsdk";
    ...
    public native int getP2spTaskOriginResStat(long j, P2spTaskOriginResStat p2spTaskOriginResStat);
