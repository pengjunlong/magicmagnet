...
public final class SoFanFileResult {
    ...
    public SoFanFileResult(int i, List<Data> list) {
    }

    public static /* synthetic */ SoFanFileResult copy$default(SoFanFileResult soFanFileResult, int i, List list, int i2, Object obj) {
    }
    ...
    public final SoFanFileResult copy(int i, List<Data> list) {
    }
