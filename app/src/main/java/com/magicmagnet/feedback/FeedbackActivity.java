package com.magicmagnet.feedback;
...
public final class FeedbackActivity extends BaseUActivity<cr> implements dr {
    ...
    static final class dpbdbdpbLwkLpObyKsq1lll1 extends v40 implements sh<View, mv1> {
        final /* synthetic */ FeedbackActivity dpbdpqRKAscW1lll1l;

        dpbdbdpbLwkLpObyKsq1lll1(FeedbackActivity feedbackActivity) {
        }
    ...
    public static final /* synthetic */ cr qpdpdszwYFiQbkll1ll(FeedbackActivity feedbackActivity) {
    }

    protected cr bbbddbppbHkZyStOxwRl1lll1() {
    }

    @Override // p000.dr
    public void bdpdqYMMfHmzHyUIbllllll1(String str) {
    }
    ...
    @Override // p000.dr
    public void pqqbbpbdGewtfncEzUzUgwaxnAl11lll1l(String str) {
    }
