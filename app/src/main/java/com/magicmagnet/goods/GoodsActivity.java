...
public final class GoodsActivity extends BaseUActivity<up> {
    ...
    static final class dpbdbdpbLwkLpObyKsq1lll1 extends v40 implements sh<View, mv1> {
        final /* synthetic */ bl dpbdpqRKAscW1lll1l;

        dpbdbdpbLwkLpObyKsq1lll1(bl blVar) {
        }
