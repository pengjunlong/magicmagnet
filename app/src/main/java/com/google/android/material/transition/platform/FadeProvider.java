...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    class C05281 implements ValueAnimator.AnimatorUpdateListener {
        ...
        C05281(View view, float f, float f2, float f3, float f4) {
        }
    ...
    class C05292 extends AnimatorListenerAdapter {
        final /* synthetic */ float val$originalAlpha;
        final /* synthetic */ View val$view;

        C05292(View view, float f) {
        }
