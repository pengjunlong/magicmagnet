...
class TransitionUtils {
    ...
    /* renamed from: com.google.android.material.transition.platform.TransitionUtils$1 */
    class C05441 implements CornerSizeBinaryOperator {
        ...
        C05441(RectF rectF, RectF rectF2, float f, float f2, float f3) {
        }
