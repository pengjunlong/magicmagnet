...
public final class NativeCrypto {
    static final String[] DEFAULT_PROTOCOLS = null;
    ...
    private static final boolean HAS_AES_HARDWARE = false;
    static final String OBSOLETE_PROTOCOL_SSLV3 = "SSLv3";
    static final int PKCS7_CERTS = 1;
    static final int PKCS7_CRLS = 2;
    private static final Set<String> SUPPORTED_LEGACY_CIPHER_SUITES_SET = null;
    private static final String[] SUPPORTED_PROTOCOLS = null;
    ...
    private static final String[] SUPPORTED_TLS_1_2_CIPHER_SUITES = null;
    static final Set<String> SUPPORTED_TLS_1_2_CIPHER_SUITES_SET = null;
    static final String[] SUPPORTED_TLS_1_3_CIPHER_SUITES = null;
    static final Set<String> SUPPORTED_TLS_1_3_CIPHER_SUITES_SET = null;
    static final String[] TLSV11_PROTOCOLS = null;
    static final String[] TLSV12_PROTOCOLS = null;
    static final String[] TLSV13_PROTOCOLS = null;
    static final String[] TLSV1_PROTOCOLS = null;
    ...
    private static final UnsatisfiedLinkError loadError = null;
    ...
    static native int EVP_AEAD_CTX_open(long j, byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, byte[] bArr4, int i3, int i4, byte[] bArr5) throws ShortBufferException, BadPaddingException;

    static native int EVP_AEAD_CTX_open_buf(long j, byte[] bArr, int i, ByteBuffer byteBuffer, byte[] bArr2, ByteBuffer byteBuffer2, byte[] bArr3) throws ShortBufferException, BadPaddingException;

    static native int EVP_AEAD_CTX_seal(long j, byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, byte[] bArr4, int i3, int i4, byte[] bArr5) throws ShortBufferException, BadPaddingException;

    static native int EVP_AEAD_CTX_seal_buf(long j, byte[] bArr, int i, ByteBuffer byteBuffer, byte[] bArr2, ByteBuffer byteBuffer2, byte[] bArr3) throws ShortBufferException, BadPaddingException;
